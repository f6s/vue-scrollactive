      ...
      var a = (function (t, e, r, n, o, i, s, l) {
      ...
      })(
        {
          props: {
            ...
            offset: { type: [Number, Function], default: 20 },
            ...
            getItemInsideWindow: function () {
              ...
              return (
                [].forEach.call(this.items, function (r) {
                  ...
                  if (o) {
                    var i =
                        !!e.scrollContainer && 'scrollTop' in e.scrollContainer
                          ? e.scrollContainer.scrollTop
                          : window.pageYOffset,
                      u = typeof e.offset === 'function' ? e.offset(o) : e.offset,
                      s = i >= e.getOffsetTop(o) - u,
                      l = i < e.getOffsetTop(o) - u + o.offsetHeight;
            ...
            scrollTo: function (y) {
              ...
              return new Promise(function (r) {
                ...
                window.requestAnimationFrame(function t(n) {
                  ...
                  var w = typeof e.offset === 'function' ? e.offset(y) : e.offset,
                    u = e.scrollOffset || w,
                    f = o + l(c) * (i - u);
            ...
            scrollToHashElement: function () {
              ...
              if (e) {
                ...
                r &&
                  ...
                  setTimeout(function () {
                    var u = typeof t.offset === 'function' ? t.offset(r) : t.offset,
                      n = r.offsetTop - u;
